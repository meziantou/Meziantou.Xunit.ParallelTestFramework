...
Please read these guidelines before contributing to meziantou/Meziantou.Xunit.ParallelTestFramework:
...
If you have questions about how to use meziantou/Meziantou.Xunit.ParallelTestFramework, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.Xunit.ParallelTestFramework's existing code formatting and naming standard
- Run meziantou/Meziantou.Xunit.ParallelTestFramework's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.Xunit.ParallelTestFramework you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
