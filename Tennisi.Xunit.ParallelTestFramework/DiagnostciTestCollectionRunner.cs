...
public sealed class DiagnosticTestTestCollectionRunner : XunitTestCollectionRunner
{
    public DiagnosticTestTestCollectionRunner(ITestCollection testCollection,
    ...
    protected override Task<RunSummary> RunTestClassAsync(ITestClass testClass, IReflectionTypeInfo @class,
        IEnumerable<IXunitTestCase> testCases)
        => new DiagnosticTestClassRunner(testClass, @class, testCases, DiagnosticMessageSink, MessageBus,
