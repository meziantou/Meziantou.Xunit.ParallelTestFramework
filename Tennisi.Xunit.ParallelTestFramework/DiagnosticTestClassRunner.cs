...
public sealed class DiagnosticTestClassRunner : XunitTestClassRunner
{
    public DiagnosticTestClassRunner(ITestClass testClass,
    ...
    private bool ToDisableParallelization()
    {
    ...
    {
        var disableParallelization = ToDisableParallelization();

        var inst = new DiagnosticTestMethodRunner(testMethod, Class, method, testCases, DiagnosticMessageSink,
            MessageBus,
            new ExceptionAggregator(Aggregator),
            CancellationTokenSource, constructorArguments, disableParallelization);
